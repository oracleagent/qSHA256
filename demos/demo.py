#!/usr/bin/env python3
"""
EXPERIMENTAL QUANTUM SHA-256 DEMO - NOT SECURE

⚠️  WARNING: This script demonstrates experimental quantum SHA-256 implementation
...
⚠️  FOR DEMONSTRATION ONLY - This demo shows quantum circuit implementations
    of SHA-256 operations using Qiskit, but they are not suitable for any
    security-critical applications.

This demo is completely separate from the main qSHA256 secure library.
...
warnings.warn(
    "You are running experimental quantum SHA-256 demo. "
...
# Import our experimental quantum SHA-256 implementation
import sys
import os
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

from demos.hash import QuantumSHA256
from demos.utils import calculate_entropy, calculate_coherence, analyze_state_evolution
...
def run_quantum_demo():
    ...
    print("=== EXPERIMENTAL Quantum SHA-256 Demo ===")
    print("⚠️  WARNING: This is for educational purposes only. NOT SECURE.")
    print("⚠️  Use qsha256.secure for production cryptography.\n")
    ...
    print("Creating experimental quantum SHA-256 circuit...")
    ...
    print("⚠️  Remember: This is for educational purposes only. NOT SECURE.")
...
def create_visualizations(state_analysis: dict, simulation_results: dict):
    ...
    fig.suptitle('EXPERIMENTAL Quantum SHA-256 Analysis\n⚠️ NOT SECURE - Educational Only', fontsize=16)
    ...
    if 'error' not in state_analysis:
        ...
        ax1.set_title('Quantum State Metrics (NOT SECURE)')
    ...
    if 'error' not in state_analysis:
        ...
        ax2.set_title('Circuit Metrics (NOT SECURE)')
        ...
        if any(basic_info):
            ...
            ax2.set_title('Basic Circuit Metrics (NOT SECURE)')
        else:
    ...
    if 'error' not in simulation_results and simulation_results.get('counts'):
        ...
        ax3.set_title('Measurement Outcomes (NOT SECURE)')
    ...
    if 'error' not in state_analysis:
        ...
        ax4.set_title(f'Quantum Volume: {quantum_volume:.2f} (NOT SECURE)')
    ...
    plt.tight_layout()
    plt.savefig('experimental_quantum_sha256_analysis.png', dpi=300, bbox_inches='tight')
    print("Visualization saved as 'experimental_quantum_sha256_analysis.png'")
    ...
    try:
        ...
        circuit_fig = circuit_drawer(simple_circuit, output='mpl', 
                                   ...
                                   scale=0.8)
        circuit_fig.savefig('experimental_quantum_sha256_circuit.png', dpi=300, bbox_inches='tight')
        print("Circuit diagram saved as 'experimental_quantum_sha256_circuit.png'")
...
def main():
    ...
    try:
        ...
        print("\n=== Summary ===")
        if 'error' not in state_analysis:
            print("✓ Experimental quantum circuit created successfully")
        ...
        print("⚠️  DO NOT USE FOR PRODUCTION CRYPTOGRAPHY!")
        print("⚠️  Use qsha256.secure for production cryptographic operations.")
        
    except Exception as e:
        print(f"Demo failed with error: {e}")
        print("Make sure you have all required dependencies installed:")
        print("pip install qiskit numpy matplotlib")
        print("\n⚠️  Remember: This is for educational purposes only. NOT SECURE.")
